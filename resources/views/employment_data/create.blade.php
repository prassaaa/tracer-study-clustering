        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('employment-data.store') }}">
                        @csrf
                            ...
                            <div class="mb-4">
                                ...
                                <select name="alumni_id" id="alumni_id" required
                                    ...
                                    @foreach($alumni as $alumnus)
                                        <option value="{{ $alumnus->id }}" {{ old('alumni_id') == $alumnus->id ? 'selected' : '' }}>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="salary" id="salary" value="{{ old('salary') }}" min="0" step="100000"
                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            @error('salary')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="waiting_period" id="waiting_period" value="{{ old('waiting_period', 0) }}" required min="0" step="1"
                                   class="mt-1 focus:ring-blue-500 focus:border-blue-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                        ...
                        <div class="mb-4">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" name="is_relevant" id="is_relevant" value="1" {{ old('is_relevant') ? 'checked' : '' }}
                        ...
                        <div class="mb-4">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" name="is_current_job" id="is_current_job" value="1" {{ old('is_current_job', true) ? 'checked' : '' }}
                                           class="focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 rounded">
                                </div>
                                <div class="ml-3 text-sm">
                        ...
                        <div id="end_date_container" class="mb-4" style="display: none;">
